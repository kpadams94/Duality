...
public abstract class AeroberArmorItem extends ArmorItem {
	...
	public static class Helmet extends AeroberArmorItem {
		public Helmet() {
	...
	public static class Chestplate extends AeroberArmorItem {
		public Chestplate() {
	...
	public static class Leggings extends AeroberArmorItem {
		public Leggings() {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "duality:textures/models/armor/aerober_layer_2.png";
		}
	}

	public static class Boots extends AeroberArmorItem {
		public Boots() {
